...
import 'package:socially/pages/edit_profile.dart';
...
import 'package:socially/widgets/post_tile.dart';
            ...
            children: <Widget>[
              Row(children: <Widget>[
                CircleAvatar(
                  ...
                  //expanded widget expands row column
                  Expanded(
                    flex:1 ,
  ...
  return Container(
      ...
      (
        ...
        children: <Widget>[
          ...
          Icon(Icons.camera_alt,color:Colors.black, size:50.0),       
