...
import 'package:socially/pages/comments.dart';
...
class Post extends StatefulWidget {
  ...
  int getLikeCount(likes){
    ...
    int count = 0;
    //if the key is expcilitely set to true, add a like
         ...
         children: <Widget>[
          ...
          showHeart ? Animator(
            ...
            Transform.scale(
              ...
              child:Icon(
              Icons.favorite , size: 80.0 , color: Colors.red[700])         
              ),
